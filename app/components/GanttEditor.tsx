  ...
  if (saveStatus === "loading") {
    return (
      <div className="p-10 flex items-center gap-3 text-gray-500">
        <div className="w-4 h-4 border-2 border-gp-dark border-t-transparent rounded-full animate-spin" />
        Loading projects…
      </div>
    );
  }

  if (!proj) return <div className="p-10 text-gray-500">No projects yet. Click &quot;+ New Project&quot; to get started.</div>;
